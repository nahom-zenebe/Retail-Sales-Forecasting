...
# Load datasets
train = pd.read_csv("/Users/Apple/Desktop/rossmann-store-sales/data/train.csv", parse_dates=["Date"])
test = pd.read_csv("/Users/Apple/Desktop/rossmann-store-sales/data/test.csv", parse_dates=["Date"])
store = pd.read_csv("/Users/Apple/Desktop/rossmann-store-sales/data/store.csv")
